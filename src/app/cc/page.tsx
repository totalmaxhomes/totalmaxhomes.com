...
export default function CCPage() {
    ...
    const features1 = [
        { image: '/Private-Night-Club-large-004-7-Kitchen-1500x1000-72dpi.jpg', title: 'Indoor Kitchen', description: 'Indoor Kitchen: Equipped with 4 ovens, 2 microwaves, a dozen stove tops, multiple refrigerators, wine coolers, a double tap kegerator, ice machine, and multiple sinks Outdoor Kitchen: Includes 5-burner BBQs, an industrial work burner, huge 20 chicken rotisserie, and a 6-burner stove top' },
